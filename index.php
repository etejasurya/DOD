...
<html lang="en">
    <head>
        <title>Doctor Appointment Dashboard || Home Page</title>
                            ...
                            <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="images/slider/hush-naidoo-jade-photography-yo01Z-9HQAw-unsplash.jpg" class="img-fluid" alt="">
                                    </div>

                                    <div class="carousel-item">
                                        <img src="images/slider/jeremy-alford-O13B7suRG4A-unsplash.jpg" class="img-fluid" alt="">
                                    </div>

                                    <div class="carousel-item">
                                        <img src="images/slider/alexandr-podvalny-tE7_jvK-_YU-unsplash.jpg" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-6 ps-0">
                            <img src="images/gallery/mat-napo-pIJ34ZrZEEw-unsplash.jpg" class="img-fluid galleryImage" alt="get a vaccine" title="get a vaccine for yourself">
                        </div>

                        <div class="col-lg-6 col-6 pe-0">
                            <img src="images/gallery/female-doctor-with-presenting-handgesture.jpg" class="img-fluid galleryImage" alt="wear a mask" title="wear a mask to protect yourself">
                        </div>
